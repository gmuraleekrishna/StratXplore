...
sys.path.insert(0,
                '/home/krishna/Projects/Matterport3DSimulatorDocker/build_out')
import MatterSim
...
def load_viewpoint_ids(connectivity_dir):
    ...
    with open(os.path.join(connectivity_dir, 'scans.txt')) as f:
        scans = [x.strip() for x in f]  # load all scan
    for scan in scans:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--scan_dir', default='/mnt/Storage1/Krishna/datasets/matterport/v1/scans')  # mp3d scan path
