...
sys.path.insert(0, '/home/krishna/Projects/Matterport3DSimulatorDocker/build_out')  # compile mp3d sim in CPU mode
import MatterSim
import math
import numpy as np
import json
...
def build_habitat_sim(scan):
    sim = HabitatUtils(f'/mnt/Storage1/Krishna/datasets/matterport/v1/tasks/mp3d/{scan}/{scan}.glb', int(0),
                       int(math.degrees(HFOV)), HEIGHT, WIDTH)
    return sim
