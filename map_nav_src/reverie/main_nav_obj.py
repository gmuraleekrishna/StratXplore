...
def build_dataset(args, rank=0):
    ...
    if args.aug is not None:
        ...
        aug_env = dataset_class(
            ...
            multi_endpoints=args.multi_endpoints, multi_startpoints=args.multi_startpoints, args=args,
        )
    else:
        aug_env = None
    ...
    if args.aug_only:
        ...
        train_instr_data = construct_instrs(
            ...
            tokenizer=args.tokenizer, max_instr_len=args.max_instr_len, load_objects=args.enable_path_correction
        )
    ...
    for split in val_env_names:
        ...
        val_env = dataset_class(
            ...
            max_objects=None, multi_endpoints=False, multi_startpoints=False, args=args,
...
def train(args, train_env, val_envs, aug_env=None, rank=-1):
    ...
    for idx in range(start_iter, start_iter + args.iters, args.log_every):
        ...
        if aug_env is None:
            ...
            listner.train(interval, feedback=args.feedback, current_iters=iter)  # Train interval iters
        else:
        ...
        if default_gpu:
            ...
            write_to_record_file(
                "\ntotal_actions %d, max_length %d, entropy %.4f, IL_loss %.4f, PC_loss %.4f, OG_loss %.4f, policy_loss %.4f, critic_loss %.4f" % (
                    total, length, entropy, IL_loss, PC_loss, OG_loss, policy_loss, critic_loss),
                record_file
            )
