...
def get_vlnbert_models(args, config=None):
    ...
    vis_config.fix_path_correction_branch = args.fix_path_correction_branch
    vis_config.enable_path_correction = args.enable_path_correction
    vis_config.use_knowledge = args.use_knowledge
    vis_config.top_k_facts = args.hparams.get('top_k_facts', 6)
    vis_config.top_k_attribs = args.hparams.get('top_k_attribs', 6)
    vis_config.fact_dropout = args.hparams.get('fact_dropout', 0.3)
    ...
    vis_config.map_dim = args.map_dim
