...
def parse_args():
    ...
    parser.add_argument('--fix_path_correction_branch', action='store_true', default=False)

    parser.add_argument('--enable_path_correction', action='store_true', default=False)
    parser.add_argument('--use_complete_candidate', action='store_true', default=False)
    parser.add_argument('--use_weighted_candidate', action='store_true', default=False)
    parser.add_argument('--use_knowledge', action='store_true', default=False)
    ...
    parser.add_argument("--pc_weight", type=float, default=0.3)
    parser.add_argument("--know_root_path", type=str, default='../knowledge_features')
    ...
    parser.add_argument("--map_dim", default=21, type=int)
    parser.add_argument("--map_res", default=0.5, type=float)
...
def postprocess_args(args):
    ...
    if args.hparams is not None:
        args.hparams = parse_hparam(args.hparams)
    if args.map_dim > 21:
        args.batch_size = 2
